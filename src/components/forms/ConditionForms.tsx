import { Box, Stack, Paper, IconButton, Typography } from '@mui/material'
...
export const PercentageConditionForm = ({ control, index, onDelete }: BaseConditionFormProps): JSX.Element => (
  <Paper sx={{ p: 2 }}>
    <Stack spacing={2}>
      ...
      <FormTextField
        control={control}
        name={`conditions.conditions.${index}.value` as const}
        label="Percentage"
        type="number"
        fullWidth
  ...
  <Paper sx={{ p: 2 }}>
    <Stack spacing={2}>
      ...
      <FormTextField
        ...
        label="Email Domains"
        fullWidth
        helperText="Comma-separated domains (e.g., example.com)"
      />
      <FormTextField
        control={control}
      ...
      <FormTextField
        ...
        label="User Types"
        fullWidth
        helperText="Comma-separated user types"
      />
    </Stack>
  </Paper>
)
