...
export function SitemarkIcon(): JSX.Element {
  return (
...
export function IndiaFlag(): JSX.Element {
  return (
    <SvgIcon>
...
export function UsaFlag(): JSX.Element {
  return (
    <SvgIcon>
...
export function BrazilFlag(): JSX.Element {
  return (
    <SvgIcon>
...
export function GlobeFlag(): JSX.Element {
  return (
    <SvgIcon>
      <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
