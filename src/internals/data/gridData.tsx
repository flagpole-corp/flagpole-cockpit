...
function renderSparklineCell(params: GridCellParams<SparkLineData, any>): JSX.Element | null {
...
function renderStatus(status: 'Online' | 'Offline'): JSX.Element {
...
// eslint-disable-next-line
export function renderAvatar(params: GridCellParams<{ name: string; color: string }, any, any>): JSX.Element | string {
